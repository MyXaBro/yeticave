...
<form class="form form--add-lot container <?= $classname; ?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
    ...
    <div class="form__container-two">
        <?php $classname = isset($errors["lot_name"]) ? "form_item--invalid" : "";?>
    ...
    <?php $classname = isset($errors["message"]) ? "form_item--invalid" : "";?>
    <div class="form__item form__item--wide <?=$classname?>">
        <label for="message">Описание <sup>*</sup></label>
        <textarea id="message" name="message" placeholder="Напишите описание лота"><?php /** @var array $lot */?>
            <?= $lot["message"];?></textarea>
