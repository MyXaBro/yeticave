                ...
                <?php foreach ($goods as $good): ?>
                    <li class="lots__item lot">
                        ...
                        <div class="lot__info">
                            ...
                            <h3 class="lot__title"><a class="text-link" href="/lot.php?id=<?= $good["id"]; ?>"><?= htmlspecialchars($good["names_lot"]); ?></a></h3>
                            <div class="lot__state">
                                <div class="lot__rate">
                                    <span class="lot__amount">Стартовая цена</span>
                                    <span class="lot__cost"><?= format_price(htmlspecialchars($good["start_price"])); ?></span>
                                </div>
                                <?php $res = time_counter(htmlspecialchars($good["time_finished"])) ?>
